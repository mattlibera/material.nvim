...
M.async_highlights.editor = function()
    local editor_hls = {
        ...
        SpellBad      = { sp = m.red, italic = true, undercurl = true },
        SpellCap      = { sp = m.blue, italic = true, undercurl = true },
        SpellLocal    = { sp = m.cyan, italic = true, undercurl = true },
        SpellRare     = { sp = m.purple, italic = true, undercurl = true },
